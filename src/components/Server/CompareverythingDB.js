...
app.post('/insert', (req,res)=> {
    ...
    db.query("INSERT INTO product (Pname, Qty,PriceAmazon,PriceFlipkart,PriceLS,PImage,PDisc,PType,Category,AmazonLink,FlipkartLink) VALUES (?,?,?,?,?,?,?,?,?,?,?)",[pname,qty,prcamz,prcflp,prcls,pimg,pdisc,ptype,ctgy,amzlnk,flplnk], (err,result)=>{
       if(err)return res.json(err); 
       return res.json(data);
    });   
});
